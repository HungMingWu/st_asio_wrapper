...
namespace tcp
{
	...
	public:
		...
		virtual bool restore_socket(const std::shared_ptr<tracked_executor>& socket_ptr, boost::uint_fast64_t id) = 0;
		virtual std::shared_ptr<tracked_executor> find_socket(boost::uint_fast64_t id) = 0;
	};
} //namespace
